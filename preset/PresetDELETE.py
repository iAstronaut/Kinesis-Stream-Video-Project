...
from ims_db.camera_db import get_camera, delete_cam_preset
from ims_utils.gateway import remove_preset, get_presets
...
def main_process(event, user_data):
    try:
        ...
        remove_preset(camera, int(preset_id))
        delete_cam_preset(camera_id, preset_id)
        return get_success_response(HTTPStatus.OK.value, "Remove Success")
